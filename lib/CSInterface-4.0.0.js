...
/**
 * attempst to write stuff
 *
 * @return string
 */
CSInterface.prototype.vipynesConsoleLog = function()
{
    document.write('console.log', this);
    document.write('console.log s  this        ', JSON.stringify(this));
    document.write('console.log STRINGIFY', JSON.stringify(window.__adobe_cep__));
    document.write('console.log PARSE', JSON.parse(window.__adobe_cep__));
    return JSON.stringify(window.__adobe_cep__);
};
